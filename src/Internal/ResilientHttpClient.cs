...
namespace Glory.Services.Core.Internal
{
    ...
    /// </summary>
    internal class ResilientHttpClient
    {
        ...
        public Task<string> GetStringAsync(string uri, string authorizationToken = null, string authorizationMethod = "Bearer")
        {
            ...
            return HttpInvoker(origin, async () =>
            {
                ...
                _logger.LogInformation($"GET:{uri}, status:{response.StatusCode}");
        ...
        private Task<HttpResponseMessage> DoPostPutAsync<T>(HttpMethod method, string uri, T item, string authorizationToken = null, string requestId = null, string authorizationMethod = "Bearer")
        {
            ...
            return HttpInvoker(origin, async () =>
           {
               ...
               _logger.LogInformation($"{method}:{uri}, status:{response.StatusCode}");
